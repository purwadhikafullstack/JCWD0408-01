...
interface ModalProps {
  closeModal: () => void;
  children: React.ReactNode; // To allow content inside the modal
}

export default function AddrModal({ closeModal, children }: ModalProps) {
    return (
      <div
      ...
      >
        ...
        <div className="fixed inset-0 z-10 w-screen overflow-y-auto flex items-center justify-center">
          <div className="relative w-[90%] sm:w-[60%] lg:w-[40%] min-h-[40vh] rounded-2xl bg-secondary text-main text-left shadow-xl transition-all overflow-hidden">
