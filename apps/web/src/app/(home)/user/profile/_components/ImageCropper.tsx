...
export default function ImageCropper({ closeModal, updateAvatar }:ImageCropperProps) {
    ...
    <>
      ...
      {imgSrc && (
        <div className="flex flex-col items-center">
          ...
          <button
            className="text-secondary text-sm py-2 px-4 rounded-2xl mt-4 bg-main hover:bg-main-black transition duration-300 ease-in-out transform hover:scale-105"
            onClick={() => {
