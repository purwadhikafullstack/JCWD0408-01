...
import SummaryCart from '@/components/admin-stock-management/summary-cart';
    ...
    <div id="super-admin">
      <div className="lg:ml-64">
        ...
        <div className="flex flex-col gap-5 px-10 pt-5 ">
          ...
          <button
            onClick={toggleModal}
            className="active:scale-95 duration-200 bg-main text-white p-2 flex rounded items-center justify-center w-52 mt-4"
          >
            <div>
        ...
        <div className="flex flex-col gap-5 px-10 pt-5 ">
          <button
            ...
            className="active:scale-95 duration-200 bg-main text-white p-2 flex rounded items-center justify-center w-52"
          >
            <div>
              <FaPlus size={20} className="mr-2" />
            </div>
        ...
        <div className="p-10 ">
          ...
          <div className="flex flex-wrap justify-center gap-2 sm:gap-10 mb-4 rounded-full">
            {tabs.map((tab) => (
              <button
                key={tab.name}
          ...
          <div className=" flex flex-col gap-5 text-[20px] mb-5">
            ...
            <div className="">
              <div className="flex flex-col justify-around items-center gap-5  ">
                <div className="flex flex-row justify-center items-center  rounded-[10px] border-[1px] w-full">
                <SummaryCart />
                </div>
              </div>
